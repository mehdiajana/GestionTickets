...
import com.example.gestiontickets.filter.CustomAuthenticationFilter;
import com.example.gestiontickets.filter.CustomAuthorizationFilter;
...
public class securityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().antMatchers(HttpMethod.GET,"/home/**").permitAll();
        http.cors().and();
